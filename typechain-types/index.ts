...
export type { ProjectRegistryOptimized } from "./contracts/ProjectRegistryOptimized";
export { ProjectRegistryOptimized__factory } from "./factories/contracts/ProjectRegistryOptimized__factory";
